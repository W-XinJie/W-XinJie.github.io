...
(4)单独编译kernel：
	...
	make ARCH=arm64 CROSS_COMPILE=aarch64-hisiv610-linux- menuconfig
...
(5)单独编译uboot：
	...
	make CROSS_COMPILE=aarch64-hisiv610-linux- hi3559av100es_defconfig (编译SPI版本)
	或
	make CROSS_COMPILE=aarch64-hisiv610-linux- hi3559av100es_nand_defconfig (编译NAND版本)
